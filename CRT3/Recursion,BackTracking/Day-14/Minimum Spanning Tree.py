...
V = 4
adj = [
    [(1, 1), (3, 3)],  # Node 0 is connected to Node 1 with weight 1, and Node 3 with weight 3
    [(0, 1), (2, 2)],  # Node 1 is connected to Node 0 with weight 1, and Node 2 with weight 2
    [(1, 2), (3, 4)],  # Node 2 is connected to Node 1 with weight 2, and Node 3 with weight 4
    [(0, 3), (2, 4)]   # Node 3 is connected to Node 0 with weight 3, and Node 2 with weight 4
]
...
result = solution.spanningTree(V, adj)
print(result)
